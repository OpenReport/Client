...
(function ($) {
    ...
    $.bootstrapSortable = function () {
        ...
        $('table').each(function () {
            var $this = $(this);
            $this.find('thead th.sortable').each(function (index) { $(this).attr('data-sortkey', index); });
            $this.find('th.sortable,td').each(function () { var $this = $(this); $this.attr('data-value') === undefined && $this.attr('data-value', $this.text()); });
            $this.find('thead th.sortable').each(function (index) { var $this = $(this); bsSort[index] = $this.attr('data-defaultsort'); if (bsSort[index] != null) { bsSort[index] = bsSort[index] == 'asc' ? 'desc' : 'asc'; $this.click(); } });
        });
    };
